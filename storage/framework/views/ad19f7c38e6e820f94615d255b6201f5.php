...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li  class="breadcrumb-item active" aria-current="page"><a > <?php echo e(__('s.create_category')); ?></a></li>
        </ol>
      </nav>
    </div>
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <!-- Form  starts -->
                <form action="<?php echo e(route('categories.store')); ?>" id="formDropzone" class="forms-sample imageValidation" method="POST" enctype="multipart/form-data" style="border:none; background:#FFFFFF; padding:0px;">
      <?php echo csrf_field(); ?>
      <div class="form-group">
          <label for="exampleInputName1"><?php echo e(__('s.category_name')); ?> <span>*</span></label>
          <input type="text" value="" autofocus name="category_name" class="form-control" id="exampleInputName1" placeholder="<?php echo e(__('s.category_name_placeholder')); ?>">
      </div>
      <div class="form-group">
      ...
      <!--dropzone form end-->
      <button id="formSubmitCategory" type="submit" class="btn btn-gradient-primary me-2"><?php echo e(__('s.submit')); ?></button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\semiramis\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>