...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a> <?php echo e(__('s.edit_company')); ?></a></li>
        </ol>
    </nav>
</div>
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <!-- Form  starts -->
            <form action="<?php echo e(route('companies.update', ['id' => $company->id])); ?>" class="forms-sample" method="POST" enctype="multipart/form-data" style="border:none; background:#FFFFFF; padding:0px;">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="form-group">
                    <label for="exampleInputName1"><?php echo e(__('s.company_name')); ?> <span>*</span></label>
                    <input type="hidden" name="company_id" id="company_id_hidden" value="<?php echo e($company->id ?? ''); ?>">
                    <input type="text" value="<?php echo e($company->name); ?>" autofocus name="company_name" class="form-control" id="exampleInputName1" placeholder="<?php echo e(__('s.company_name_placeholder')); ?>">
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="currency_id">
                        <option value="<?php echo e($company->currency_id); ?>" selected disabled><?php echo e($currencyName); ?></option>
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo e(asset('uploads/' . $company->image)); ?>" id="companyImage" class="companyImage" alt="Company Image">
                    <?php else: ?>
                    <img src="<?php echo e(asset('uploads/defaultCompanyImage.jpeg')); ?>" class="userImage" alt="">
                    <?php endif; ?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\semiramis\resources\views/admin/companies/edit.blade.php ENDPATH**/ ?>