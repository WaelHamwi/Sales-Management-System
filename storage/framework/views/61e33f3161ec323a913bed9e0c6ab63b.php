...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li  class="breadcrumb-item active" aria-current="page"><a > <?php echo e(__('s.edit_product')); ?></a></li>
        </ol>
      </nav>
    </div>
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <!-- Form  starts -->
              <form action="<?php echo e(route('products.update', ['id' => $product->id])); ?>" class="forms-sample" method="POST"   enctype="multipart/form-data" style="border:none; background:#FFFFFF; padding:0px;">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="form-group">
                        <label for="exampleInputName1"><?php echo e(__('s.product_name')); ?> <span>*</span></label>
                        <input type="text" value="<?php echo e($product->name); ?>" autofocus name="product_name"
                        class="form-control" id="exampleInputName1"
                        placeholder="<?php echo e(__('s.product_name_placeholder')); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($product->price); ?>" autofocus name="product_price" class="form-control" id="productPrice" placeholder="<?php echo e(__('s.product_price_placeholder')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1"><?php echo e(__('s.SKU')); ?> </label>
                        <input type="text" value="<?php echo e($product->sku); ?>" autofocus name="product_sku" class="form-control" id="productSKU" placeholder="<?php echo e(__('s.product_sku_placeholder')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName1">Barcode </label>
                        <input type="text" value="<?php echo e($product->barcode); ?>" autofocus name="product_barcode" class="form-control" id="productBarcode" placeholder="<?php echo e(__('s.product_barcode_placeholder')); ?>">
                    </div>
                    <!--dropzone form start-->
            ...
            <img src="<?php echo e(asset('uploads/' . $product->image)); ?>" id="productImage" class="productImage" alt="product Image">
            <?php else: ?>
            <img src="<?php echo e(asset('uploads/defaultproductImage.jpeg')); ?>"  class="userImage"  alt="">
          <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\semiramis\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>