...
@section('content')
    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li  class="breadcrumb-item active" aria-current="page"><a > {{__('s.create_branch')}}</a></li>
        </ol>
      </nav>
    </div>
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <!-- Form  starts -->
                <form action="{{ route('branches.store') }}" id="formDropzone" class="forms-sample imageValidation" method="POST" enctype="multipart/form-data" style="border:none; background:#FFFFFF; padding:0px;">
      @csrf
      ...
      <input type="hidden" name="branch_id" id="branch_id_hidden" value="">
          ...
          <input type="text" value="" autofocus name="branch_name" class="form-control" id="exampleInputName1" placeholder="{{ __('s.first_name_placeholder') }}">
      </div>
      <div class="form-group">
